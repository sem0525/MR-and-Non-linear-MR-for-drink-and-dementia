...
########
label_text = "All current unsafe drinkers"
...
Figur1_all_unsafe <- F2
grid.draw(Figur1_all_unsafe)
...
########
label_text = "  Male unsafe drinkers"
label_text_nonliner <- substitute(expr=paste("Non-linear test: ",italic("P"), p_nonliner1),
                                  env = base::list(p_nonliner1=p_nonliner))
F2 = f2 + labs(subtitle = label_text_nonliner, title=label_text ) 
Figur1_men_unsafe <- F2
grid.draw(Figur1_men_unsafe)
...
########
label_text = "Female unsafe drinkers"
label_text_nonliner <- substitute(expr=paste("Non-linear test: ",italic("P"), p_nonliner1),
                                  env = base::list(p_nonliner1=p_nonliner))
F2 = f2 + labs(subtitle = label_text_nonliner, title=label_text ) 
Figur1_women_unsafe <- F2
grid.draw(Figur1_women_unsafe)
