...
######Supplement Table 5&6 continous Alcohol-GS with varibales in abstainer and drinekrs#####
source(paste0(project_path,"code/sTable5&6_GS_test_abstainer_drinker.R"))
